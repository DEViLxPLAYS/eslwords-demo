...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      scooters: {
        Row: {
          anti_theft_system: boolean | null
          bluetooth: string | null
          charge_time: string
          connectivity_bluetooth: string | null
          connectivity_gps_tracking: string | null
          connectivity_mobile_app: string | null
          created_at: string
          description: string | null
          display_order: number
          features: Json | null
          ...
          is_active: boolean
          is_featured: boolean
          led_lighting_system: boolean | null
          max_range: string
          max_speed: string
          mobile_app: string | null
          mobile_app_connectivity: boolean | null
          name: string
          power_output: string | null
          price: string
          regenerative_braking: boolean | null
          smart_display: boolean | null
    ...
    Functions: {
      ...
      insert_admin: {
        Args: { email: string; id: string; name: string }
        Returns: undefined
      }
      log_login_attempt: {
